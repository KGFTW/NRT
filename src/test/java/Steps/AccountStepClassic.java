...
public class AccountStepClassic {
	...
	public void fillNewAccountFields(String elementName, String sectionName, String elementType, String required,
		...
		if (values.equals(""))
			FactoryDriver.getInstance().setValue(elementName, sectionName, elementType, requis, ACCOUNT_NAME);
		else
			FactoryDriver.getInstance().setValue(elementName, sectionName, elementType, requis, values);
	}
